...
include("./trial_functions/hylleraas_type/correlated_pol_7.jl");

function compute_symbolic_integrals_7()
  @syms x y z alpha c0 c1 c2 c3 c4 c5 phi
  m1 = m1_he
  m2 = m2_he
  m3 = m3_he
  q1 = q1_he
  q2 = q2_he
  q3 = q3_he
  phi = correlated_pol_7(x, y, z, alpha, c0, c1, c2, c3, c4, c5)
